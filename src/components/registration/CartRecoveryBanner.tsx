...
export default function CartRecoveryBanner({
  ...
  return (
    /* Single responsive banner — top bar on desktop, sticky bottom sheet on mobile */
    <div className="w-full sm:static sm:bg-amber-50 sm:border-b sm:border-amber-200 sm:px-4 sm:py-3 fixed bottom-0 left-0 right-0 z-40 bg-white border-t border-amber-200 shadow-2xl px-4 py-4 sm:shadow-none">
      {/* Desktop layout */}
